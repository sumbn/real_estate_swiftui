...
class AppleAuthService : NSObject, SignInServiceProtocol {
    
    private var currentNonce: String?
    
    private var authentication: AuthenticationModel?
    private var completion: ((AuthenticationResult) -> Void)?
    ...
    func startSignInWithAppleFlow() {
        guard let rootViewController = Utilities.shared.rootViewController() else {
            return
        }
